...
import xyz.zzj.interviewBank_zzj.config.WxOpenConfig;
...
import xyz.zzj.interviewBank_zzj.model.dto.user.UserAddRequest;
import xyz.zzj.interviewBank_zzj.model.dto.user.UserLoginRequest;
import xyz.zzj.interviewBank_zzj.model.dto.user.UserQueryRequest;
import xyz.zzj.interviewBank_zzj.model.dto.user.UserRegisterRequest;
import xyz.zzj.interviewBank_zzj.model.dto.user.UserUpdateMyRequest;
import xyz.zzj.interviewBank_zzj.model.dto.user.UserUpdateRequest;
...
import static xyz.zzj.interviewBank_zzj.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getSignInRecord(HttpServletRequest request, Integer year) {
        //必须登录才能查看签到记录
        User loginUser = userService.getLoginUser(request);
        //查询签到记录
        List<Integer> signRecord = userService.selectSignRecord(loginUser.getId(),year);
        //返回签到记录
        return ResultUtils.success(signRecord);
    }
}
